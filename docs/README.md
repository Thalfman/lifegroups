...
| [`adr/`](./adr/)                                                               | Architecture Decision Records (0001–0032; the pivot is 0016–0022, amended by 0023–0024; later amendments 0026–0030 cover flag reads, the home workspace, the page runner, manual Plan readiness, and the Multiply type-intent pipeline; 0031–0032 are the two renumbered duplicate-collision ADRs — jsonb-write re-guard and invitee-chooses-own-name).                              |
