...
| [`architecture/oversight-ladder.drawio`](./architecture/oversight-ladder.drawio) | 🖼️ Editable diagram of the oversight ladder (downward-visibility) + the two privacy exceptions. Companion to `RLS_VISIBILITY.md`.                                                                                                                         |
| [`architecture/navigation-spine.drawio`](./architecture/navigation-spine.drawio) | 🖼️ Editable diagram of the Care · Plan · Multiply nav spine, management tabs, and the off-nav frozen surfaces.                                                                                                                                            |
...
| [`adr/`](./adr/)                                                                 | Architecture Decision Records (0001–0025; the pivot is 0016–0022, amended by 0023–0024).                                                                                                                                                                  |
| [`agents/`](./agents/)                                                           | Agent/skill config: domain-doc rules, issue tracker, triage labels.                                                                                                                                                                                       |
| [`runbooks/`](./runbooks/)                                                       | Operator how-tos: [release process](./runbooks/RELEASE.md), [backup & restore](./runbooks/BACKUP_AND_RESTORE.md), [launch checklist](./runbooks/LAUNCH_RUNBOOK.md), [seeded-auth route smoke](./runbooks/SEEDED_AUTH_ROUTE_SMOKE.md), live-surface setup. |
