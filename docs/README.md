...
| [`adr/`](./adr/)                                                               | Architecture Decision Records (0001–0033; the pivot is 0016–0022, amended by 0023–0024; later amendments 0026–0030 cover flag reads, the home workspace, the page runner, manual Plan readiness, and the Multiply type-intent pipeline; 0031–0032 are the two renumbered duplicate-collision ADRs — jsonb-write re-guard and invitee-chooses-own-name; 0033 keeps the off-nav pre-pivot surfaces). |
| [`agents/`](./agents/)                                                         | Agent/skill config: domain-doc rules, issue tracker, triage labels.                                                                                                                                                                                                                                                                                                                                |
| [`audits/`](./audits/)                                                         | Periodic full-codebase audit reports (security, architecture, tests, docs). Latest: [`2026-06-21-full-codebase-audit.md`](./audits/2026-06-21-full-codebase-audit.md).                                                                                                                                                                                                                             |
