...
export interface MultiplicationCandidatesRow {
  ...
  // ADR 0029: the three formerly-computed readiness criteria, now manual flags
  // Julian ticks per candidate (mirroring shepherd_willing / needs_similar_stage).
  // Additive NOT NULL DEFAULT false; existing rows read false (no backfill).
