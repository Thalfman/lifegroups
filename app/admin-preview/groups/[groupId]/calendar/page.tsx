...
const DEMO_GROUP = {
  id: "fallback-preview-group",
  name: "Anderson Life Group",
  meetingDay: "Saturday",
  meetingTime: "18:00",
...
export default async function AdminPreviewCalendarPage({
  searchParams,
}: {
  ...
  return (
    <PastoralAppShell
      ...
      eyebrow="Admin preview · Group calendar"
      title={DEMO_GROUP.name}
      titleItalic="— calendar"
      lede="Public design preview of the admin calendar. Generated meeting occurrences appear automatically from the group's schedule."
      contentMaxWidth={920}
    ...
    >
      <div style={{ display: "grid", gap: 14 }}>
        ...
        >
          <Link href="/admin-preview" style={{ color: P.ink2, textDecoration: "none" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
            {prevMonth ? (
              <Link
                href={`/admin-preview/groups/${DEMO_GROUP.id}/calendar?month=${prevMonth}`}
                style={navLinkStyle}
              >
            ...
            <Link
              href={`/admin-preview/groups/${DEMO_GROUP.id}/calendar`}
              style={navLinkStyle}
            >
              This month
            </Link>
            {nextMonth ? (
              <Link
                href={`/admin-preview/groups/${DEMO_GROUP.id}/calendar?month=${nextMonth}`}
                style={navLinkStyle}
              >
