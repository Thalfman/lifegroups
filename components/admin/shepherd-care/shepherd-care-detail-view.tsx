// Presentational body for the shepherd-care person detail page (issue #822 /
// audit ARCH-5). Server component (no "use client"): the page resolves the
// spine (guard + 404 + header) and hands off here inside its Suspense
// boundary; this module loads the full detail bundle and renders the tabbed
// panels. Interactive controls stay in their own client components.
...
export async function ShepherdCareDetailBody({
  profileId,
  creatorProfileId,
  actorRole,
  ministryYear,
