...
// Shared Multiply constants (#380 → #403). The three top types and their labels,
// plus the off-season-aware ministry-year helper. These outlived the original
// per-type boards: the boards folded into the per-cell grid (#403, see
// multiply-grid-data.ts), but Settings (the per-type multiplication-config editor
// and the readiness-rule editor) and other surfaces still read them, so they keep
// their home here.
