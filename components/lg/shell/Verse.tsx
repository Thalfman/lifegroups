export function Verse() {
  return (
    <div className="relative overflow-hidden rounded-sm border border-line bg-sageTint p-3.5">
      <div className="mb-2 font-sans text-xs font-bold uppercase tracking-[0.16em] text-clay">
      ...
      <div className="mt-1.5 font-sans text-xs font-semibold uppercase tracking-[0.12em] text-ink3">
        Colossians 1:28
      </div>
    </div>
  );
